...
public class RecipientAndSenderDetails extends BaseClass {
	...
	public void enterRecipientDetails() {
		...
		try {
			customizeGiftCards = new GiftCardCustomization();
			customizeGiftCards.validateGiftCardButton();
			customizeGiftCards.navigateToGiftCardsPage();
			customizeGiftCards.giftCardCustomization();
